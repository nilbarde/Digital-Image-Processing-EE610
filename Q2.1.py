...
if __name__ == "__main__":
	...
	for i in range(len(noisyImgs)):
		...
		cv2.imwrite("./Results/Q2.1 std devi : " + str(round(StdDevi[i],2)) + " filtered output.png",noisyImgsFiltered[i])
	...
	plt.savefig("./Results/Q2.1.1 - RRMSE degraded image.png")
	plt.show()
	plt.plot(StdDevi,RRMSEfiltered)
	plt.savefig("./Results/Q2.1.2 - RRMSE filtered images.png")
	plt.show()
